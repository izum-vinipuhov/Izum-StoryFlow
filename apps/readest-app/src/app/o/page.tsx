...
const OpenAnnotationLanding = () => {
  ...
  return (
    <main className='bg-base-200 flex min-h-dvh flex-col items-center justify-center p-4 sm:p-8'>
      <Card>
        <BrandHeader
          title={_('Open in Izum StoryFlow')}
          subtitle={
            showManualOpen
              ? _("If Izum StoryFlow didn't open automatically, choose an option below:")
        ...
        {!showManualOpen && (
          ...
          >
            ...
            <span className='text-base-content/70 text-sm'>{_('Opening Izum StoryFlow...')}</span>
          </div>
        )}
